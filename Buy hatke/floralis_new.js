...
var selector2 = [];
selector2.push({selector: '.descarea .pricerate', attr: 'none', pos: 'before'});
selector2.push({selector: '.chkbg:eq(0)', attr: 'none', pos: 'before'});
...
title = title.split("(")[0];
  ...
  var imgURL = returnResource("floralis.png");


  $('.chkbg').find('li:eq(2)').after('<li><img src='+ imgURL + ' title="Compare via Compare Hatke" align="absmiddle"><a target="_blank" href=' + urlToFollow + '>Compare</a></li>');
