...
var selector2 = [];
selector2.push({selector: '.prodDetails .detailHead', attr: 'none', pos: 'after'});
...
title = title.split("(")[0];
  ...
  if($('.prodDetails .detailHead').length>0){
    $('.prodDetails .detailHead:eq(0)').after('<a target="_blank" title="Compare via Compare Hatke" href="' + urlToFollow + '" ><div class="buy_compare" style="padding: 10px 35px; color: #fff; background: #515050; border: none; font-size: 16px; font-weight: bold; width: 31%;display: inline-block;border-radius: 2px;">Compare Prices</div></a>');
  }
