...
prod = getProd();
var selector = [];
selector.push({selector: '#customer_view_products', attr: 'none', pos: 'before'});
selector.push({selector: '#recently_view', attr: 'none', pos: 'before'});
selector.push({selector: '#ship_data', attr: 'none', pos: 'before'});
