...
var selector2 = [];
selector2.push({selector: '#bk-big-info-holder .prcdtls:eq(0)', attr: 'none', pos: 'after'});
selector2.push({selector: '#bk-big-info-holder .buy_this_now:eq(0)', attr: 'none', pos: 'before'});
...
title = title.split("(")[0];
  ...
  var imgURL = returnResource("acadzone.png");
  ...
  else if($('#bhWidget').length > 0){
    $('#bhWidget').after('<a target= "blank_" title="Compare via Compare Hatke" href="' + urlToFollow + '"><img src=' + imgURL + ' title="Compare via Compare Hatke" style="margin-left: 28px;"></a>');
