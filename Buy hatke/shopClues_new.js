...
name = name.split("(")[0];
  ...
  //$('.pro_det_add_to_cart_butto:eq(0)').after('<a target="_blank" title="Compare via Compare Hatke" href="' + url + '" ><div class="buy"><span style="margin-top: 2px;padding-top: 17px;height: 32px;border-radius: 0px;" class="buy-now button big fill"><span class="pdp-sprite icon-plus"></span>Compare Prices</span></div></a>');
