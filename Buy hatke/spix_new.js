...
$('.compare:eq(0)').after('<a target="_blank" href="' + urlToFollow + '" class="button compare" pname="Sogo SS-083 Trimmer For Men"><i class="i-btn-cmp"></i><span>Compare Prices</span></a>');
  price = getPrice();
  origPrice = price;
