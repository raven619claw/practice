...
var name = $('.aboutproduct').find('h1:eq(0)').text();
origProd = name;
...
var imgURL = chrome.extension.getURL("futurebazaar.png");
$('.cartbuttondiv').after('<a target="_blank" href=' + url + ' title="Compare via Compare Hatke"><img src=' + imgURL + ' title="Compare via Compare Hatke" style="margin-top: 7px;"></a>');

var price = $('.offer').html().split("</span>")[1].trim();
price = price.split(",");
price = price.join("");
