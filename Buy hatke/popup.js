...
function showAlerts(){
  ...
  for(var w=0;w<lim;w++){
    ...
    var final_link = "http://pa.buyhatke.com/Navigation/?pos="+position_logo+"&source=ext_alert_view&link="+encodeURIComponent(link);
...
var jsonArr = [{'mode':0,'listener':1,'type':5,'pid':'0','website':'0'}];
  ...
  xhttp.open("POST", "http://52.77.254.109/bhuwan", true);
