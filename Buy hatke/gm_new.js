...
var selector2 = [];
selector2.push({selector: '#apparel_product_price_new_left', attr: 'none', pos: 'before'});
...
title = title.split("(")[0];
  ...
  if($('#apparel_product_price_new_left').length>0){
    $('#apparel_product_price_new_left').after('<a target="_blank" title="Compare via Compare Hatke" href="' + urlToFollow + '" ><div class="buy_compare" style="padding: 10px 27px; color: #fff; background: #D20100; border: none; font-size: 12px; font-weight: bold; width: 43%;margin-top: 5px;text-align: center;display: inline-block;">Compare Prices</div></a>');
  }
